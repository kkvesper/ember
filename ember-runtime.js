...
enifed('container/registry', ['exports', 'ember-metal/core', 'ember-metal/dictionary', 'ember-metal/keys', 'ember-metal/merge', './container'], function (exports, _emberMetalCore, _emberMetalDictionary, _emberMetalKeys, _emberMetalMerge, _container) {
  ...
  */
  ...
  function deprecateResolverFunction(registry) {
    _emberMetalCore["default"].deprecate('Passing a `resolver` function into a Registry is deprecated. Please pass in a Resolver object with a `resolve` method.', false, { id: 'ember-application.registry-resolver-as-function', until: '3.0.0', url: 'http://emberjs.com/deprecations/v2.x#toc_registry-resolver-as-function' });
    registry.resolver = {
...
enifed('ember-metal/core', ['exports'], function (exports) {
  ...
  */
  ...
  /**
    ...
    @property VERSION
    @type String
    @default '1.13.13+00d42a2c'
    @static
    @public
  */
  Ember.VERSION = '1.13.13+00d42a2c';
